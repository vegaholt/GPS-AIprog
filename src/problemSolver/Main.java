...
public class Main {
	...
	//16 HARD
	public static int[][] sudokuPuzzle4 ={{0, 0, 0, 10, 15, 0, 0, 0, 0, 8, 9, 0, 0, 7, 0, 0},
	...
	//FROM WEBSUDOKU - MEDIUM
	public static int[][] sudokuPuzzle1 = {{0, 0, 0, 0, 7, 0, 0, 2, 4},
										   {0, 4, 0, 0, 6, 0, 1, 0, 0},
										   {0, 0, 0, 0, 0, 4, 0, 0, 5},
										   {0, 0, 4, 0, 0, 1, 2, 0, 0},
										   {3, 7, 1, 0, 0, 0, 6, 4, 9},
	...
	// FROM WEBSUDOKU - HARD
	public static int[][] sudokuPuzzle2 = {{0, 0, 7, 0, 0, 4, 0, 0, 0},
										   {9, 0, 0, 7, 0, 0, 4, 3, 0},
										   {0, 0, 0, 6, 8, 0, 9, 0, 0},
										   {0, 7, 0, 0, 0, 0, 0, 0, 5},
										   {8, 0, 1, 0, 3, 0, 2, 0, 7},
	...
	//FROM WEBSUDOKU - EVIL
	public static int[][] sudokuPuzzle3 = {{0, 0, 9, 0, 7, 0, 3, 0, 0},
										   {0, 4, 0, 8, 0, 0, 0, 0, 0},
										   {2, 7, 0, 0, 0, 5, 0, 0, 0},
										   {0, 0, 0, 0, 0, 3, 9, 0, 0},
										   {1, 0, 6, 0, 0, 0, 8, 0, 7},
